<?php namespace Smartosc\Core\Tests;

use Mockery as m;
use Smartosc\Core\Models\Permissions\PermissionProvider;
...
class PermissionProviderTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreatePermission()
    {
        ...
        $permission = m::mock('Smartosc\Core\Models\Permissions\Permission');
        ...
        $provider = m::mock('Smartosc\Core\Models\Permissions\PermissionProvider[createModel]');
    ...
    /**
     * @expectedException Smartosc\Core\Models\Permissions\ValueRequiredException
     */
    public function testCreatePermissionInvalidValue()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartosc\Core\Models\Permissions\ValueRequiredException');
    ...
    /**
     * @expectedException Smartosc\Core\Models\Permissions\NameRequiredException
     */
    public function testCreatePermissionInvalidName()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartosc\Core\Models\Permissions\NameRequiredException');
    ...
    /**
     * @expectedException Smartosc\Core\Models\Permissions\PermissionExistsException
     */
    public function testCreatePermissionThrowPermissionExists()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartosc\Core\Models\Permissions\PermissionExistsException');
    ...
    /**
     * @expectedException Smartosc\Core\Models\Permissions\PermissionNotFoundException
     */
    ...
    public function testFindingAllPermissions()
    {
        ...
        $permission1 = m::mock('Smartosc\Core\Models\Permissions\Permission')->shouldReceive('hasGetMutator')->andReturn(false);
        $permission2 = m::mock('Smartosc\Core\Models\Permissions\Permission')->shouldReceive('hasGetMutator')->andReturn(false);
