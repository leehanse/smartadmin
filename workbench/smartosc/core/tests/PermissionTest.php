...
use Mockery as m;
use Smartosc\Core\Models\Permissions\Permission;
...
class PermissionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $persistedPermission = m::mock('Smartosc\Core\Models\Permissions\Permission');
        $persistedPermission->shouldReceive('hasGetMutator')->andReturn(false);
        $persistedPermission->shouldReceive('getId')->once()->andReturn(42);

        $permission = m::mock('Smartosc\Core\Models\Permissions\Permission[newQuery]');
        $permission->id = 43;
