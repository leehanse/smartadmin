...
<html lang="en-us">
	<head>
		...
		<!-- Basic Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/bootstrap.min.css') }}">
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/font-awesome.min.css') }}">

		<!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/smartadmin-production.css') }}">
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/smartadmin-skins.css') }}">

		<!-- SmartAdmin RTL Support is under construction
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/smartadmin-rtl.css') }}"> -->

		<!-- We recommend you use "your_style.css" to override SmartAdmin
		     specific styles this will also ensure you retrain your customization with each SmartAdmin update.
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/your_style.css') }}"> -->

		<!-- Demo purpose only: goes with demo.js, you can delete this css when designing your own WebApp -->
		<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('public/packages/smartosc/core/assets/css/demo.css') }}">
		...
		<link rel="apple-touch-icon" href="{{ asset('public/packages/smartosc/core/assets/img/splash/sptouch-icon-iphone.png') }}">
		<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('public/packages/smartosc/core/assets/img/splash/touch-icon-ipad.png') }}">
		<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('public/packages/smartosc/core/assets/img/splash/touch-icon-iphone-retina.png') }}">
		<link rel="apple-touch-icon" sizes="152x152" href="{{ asset('public/packages/smartosc/core/assets/img/splash/touch-icon-ipad-retina.png') }}">
		...
		<link rel="apple-touch-startup-image" href="{{ asset('public/packages/smartosc/core/assets/img/splash/ipad-landscape.png') }}" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
		<link rel="apple-touch-startup-image" href="{{ asset('public/packages/smartosc/core/assets/img/splash/ipad-portrait.png') }}" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
		<link rel="apple-touch-startup-image" href="{{ asset('public/packages/smartosc/core/assets/img/splash/iphone.png') }}" media="screen and (max-device-width: 320px)">
                @yield('header-style')
                @yield('header-script')
	</head>
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="{{ asset('public/packages/smartosc/core/assets/img/logo.png') }}" alt="SmartAdmin"> </span>
			...
			<div class="pull-right">
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="{{ asset('public/packages/smartosc/core/assets/img/flags/us.png') }}"> <span> US </span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><img alt="" src="{{ asset('public/packages/smartosc/core/assets/img/flags/us.png') }}"> US</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img alt="" src="{{ asset('public/packages/smartosc/core/assets/img/flags/es.png') }}"> Spanish</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img alt="" src="{{ asset('public/packages/smartosc/core/assets/img/flags/de.png') }}"> German</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:void(0);" id="show-shortcut">
						<img src="{{ asset('public/packages/smartosc/core/assets/img/avatars/sunny.png') }}" alt="me" class="online" /> 
						<span>
							john.doe 
						</span>
