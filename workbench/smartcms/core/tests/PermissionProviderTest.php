...
use Mockery as m;
use Smartcms\Core\Models\Permissions\PermissionProvider;
...
class PermissionProviderTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCreatePermission()
    {
        ...
        $permission = m::mock('Smartcms\Core\Models\Permissions\Permission');
        ...
        $provider = m::mock('Smartcms\Core\Models\Permissions\PermissionProvider[createModel]');
    ...
    public function testCreatePermissionInvalidValue()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartcms\Core\Models\Permissions\ValueRequiredException');
    ...
    public function testCreatePermissionInvalidName()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartcms\Core\Models\Permissions\NameRequiredException');
    ...
    public function testCreatePermissionThrowPermissionExists()
    {
        ...
        $permission->shouldReceive('hasGetMutator')->andReturn(false);
        $permission->shouldReceive('fill')->with($attributes)->once();
        $permission->shouldReceive('save')->once()->andThrow('Smartcms\Core\Models\Permissions\PermissionExistsException');
    ...
    /**
     * @expectedException Smartcms\Core\Models\Permissions\PermissionNotFoundException
     */
    ...
    public function testFindingAllPermissions()
    {
        ...
        $permission1 = m::mock('Smartcms\Core\Models\Permissions\Permission')->shouldReceive('hasGetMutator')->andReturn(false);
        $permission2 = m::mock('Smartcms\Core\Models\Permissions\Permission')->shouldReceive('hasGetMutator')->andReturn(false);
